...
class bitrue_api:
	...
	def buy(self, market, amount, price, order_type=None, addtl_params=None):
		return self.newOrder(self.normalize_pair(market), "BUY", "LIMIT", amount, live=True, price=price)["orderId"]

	def sell(self, market, amount, price, order_type=None, addtl_params=None):
		return self.newOrder(self.normalize_pair(market), "SELL", "LIMIT", amount, price=price)["orderId"]
